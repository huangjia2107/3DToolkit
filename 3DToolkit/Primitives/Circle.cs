...
{
    public class Circle : ModelVisual3D
    {
        ...
        public static readonly DependencyProperty OriginProperty =
            DependencyProperty.Register("Origin", typeof(Point3D), typeof(Circle), new UIPropertyMetadata(new Point3D(0, 0, 0), OnOriginPropertyChanged));
        ...
        {
            var ctrl = d as Circle;
            ctrl.UpdateGeometry();
        }

        public static readonly DependencyProperty HeightProperty =
            DependencyProperty.Register("Height", typeof(double), typeof(Circle), new UIPropertyMetadata(8d, OnHeightPropertyChanged, CoerceDistance), IsValidDoubleValue);
        ...
        public static readonly DependencyProperty RadiusProperty =
            DependencyProperty.Register("Radius", typeof(double), typeof(Circle), new PropertyMetadata(4d, OnRadiusPropertyChanged, CoerceDistance), IsValidDoubleValue);
        ...
        public static readonly DependencyProperty ThicknessProperty =
            DependencyProperty.Register("Thickness", typeof(double), typeof(Circle), new PropertyMetadata(3d, OnThicknessPropertyChanged, CoerceDistance), IsValidDoubleValue);
        ...
        public static readonly DependencyProperty InnerSideMaterialProperty =
            DependencyProperty.Register("InnerSideMaterial", typeof(Material), typeof(Circle), new PropertyMetadata(new DiffuseMaterial(Brushes.LightGray), OnInnerSideMaterialPropertyChanged));
        ...
        public static readonly DependencyProperty OutterSideMaterialProperty =
            DependencyProperty.Register("OutterSideMaterial", typeof(Material), typeof(Circle), new PropertyMetadata(new DiffuseMaterial(Brushes.LightGray), OnOutterSideMaterialPropertyChanged));
        ...
        public static readonly DependencyProperty TopMaterialProperty =
            DependencyProperty.Register("TopMaterial", typeof(Material), typeof(Circle), new PropertyMetadata(new DiffuseMaterial(Brushes.Gray), OnTopMaterialPropertyChanged));
        ...
        public static readonly DependencyProperty BottomMaterialProperty =
            DependencyProperty.Register("BottomMaterial", typeof(Material), typeof(Circle), new PropertyMetadata(new DiffuseMaterial(Brushes.Gray), OnBottomMaterialPropertyChanged));
